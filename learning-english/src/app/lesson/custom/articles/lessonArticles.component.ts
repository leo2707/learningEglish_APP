...
@Component({
  selector: 'lesson-articles',
  templateUrl: './lessonArticles.component.html',
  styleUrls: ['./lessonArticles.component.css'],
  providers: [VocabularyService]
})
export class LessonArticlesComponent implements OnInit {
