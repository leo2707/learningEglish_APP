...
@Component({
  selector: 'lesson-colors',
  templateUrl: './lessonColors.component.html',
  styleUrls: ['./lessonColors.component.css'],
  providers: [VocabularyService]
})
export class LessonColorsComponent implements OnInit {
