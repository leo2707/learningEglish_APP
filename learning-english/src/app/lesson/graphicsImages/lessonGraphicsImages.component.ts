...
@Component({
  selector: 'lesson-graphics-images',
  templateUrl: './lessonGraphicsImages.component.html',
  styleUrls: ['./lessonGraphicsImages.component.css'],
...
export class LessonGraphicsImagesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    console.log("ENTROOO LessonGraphicsImages");
